...
{
    public sealed class CobaltRoleProvider : RoleProvider
    {
        //
        // Global connection string, generic exception message, event log info.
        //

        private string eventSource = "CobaltRoleProvider";
        ...
        public override void Initialize(string name, NameValueCollection config)
        {
            ...
            if (name == null || name.Length == 0)
                name = "CobaltRoleProvider";

            if (String.IsNullOrEmpty(config["description"]))
            {
                config.Remove("description");
                config.Add("description", "Cobalt Role provider");
            }
        ...
        public override void AddUsersToRoles(string[] usernames, string[] rolenames)
        {
            ...
            SqlCommand cmd = new SqlCommand("INSERT INTO UsersInRoles " +
                    ...
                    " Values(@Username, @Username, @Rolename)", conn);

            SqlParameter userParm = cmd.Parameters.Add("@Username", SqlDbType.NVarChar, 255);
            SqlParameter roleParm = cmd.Parameters.Add("@Rolename", SqlDbType.NVarChar, 255);
        ...
        public override string[] GetAllRoles()
        {
            ...
            SqlConnection conn = new SqlConnection(connectionString);
            SqlCommand cmd = new SqlCommand("SELECT Rolename FROM Roles " +
